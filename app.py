...
cities = [     'Hyderabad',         'Mumbai',      'Bangalore',        'Kolkata',
        'Chennai',         'Jaipur',      'Cape Town', 'Port Elizabeth',
         'Durban',      'Centurion',    'East London',   'Johannesburg',
      'Kimberley',      'Ahmedabad',         'Ranchi',          'Delhi',
      'Abu Dhabi',              'Sharjah',        'Cuttack',
...
if st.button('Predict Probability'):
    ...
    input_df = pd.DataFrame({'batting_team':[batting_team],'bowling_team':[bowling_team],
                  ...
                  'ball_left':[ball_left],'wickets':[wickets],
